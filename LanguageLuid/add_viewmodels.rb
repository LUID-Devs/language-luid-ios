...
# ViewModels group UUID
viewmodels_group_uuid = '4D8B68272F1E801D00E005B2'
...
files.each do |filename|
  ...
  if content =~ /(#{viewmodels_group_uuid} \/\* ViewModels \*\/ = \{[^}]+children = \([^)]+)/m
    group_section = $1
    ...
    puts "  ✓ Added to ViewModels group"
  end
